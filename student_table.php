...
<table class="table table-hover">
	...
	echo"<tr>";
	echo "<td>".$row['name']."</td>";
	echo "<td>".$row["admision_number"]."</td>";
	echo "<td>".$row["enrolment_number"]."</td>";
	...
	?>
	<a class="btn btn-primary" href="abcde.html">BACK</a>
	<center>
	 <a class="btn btn-primary" href="delete_student.php">DELETE DATA</a></center>
